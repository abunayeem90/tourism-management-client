...
const About = () => {
    return (
        ...
        <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-6">Whether you are seeking a relaxing beach getaway, an adventurous trek through the Himalayas, or a cultural immersion in the bustling cities of South Asia, we have the expertise and resources to turn your travel dreams into reality. With access to a wide range of exclusive accommodations, unique experiences, and expert guides, we tailor each itinerary to your specific interests, preferences, and budget.</p>
            
            <p className="text-lg text-gray-700 leading-relaxed mb-6">At Air Travel, we believe in responsible travel practices that promote sustainability, preserve cultural heritage, and support local communities. We strive to minimize our environmental impact and contribute to the well-being of the destinations we visit, ensuring that future generations can continue to enjoy the beauty and wonder of South Asia.</p>
            
            <p className="text-lg text-gray-700 leading-relaxed mb-6">Join us on a journey of discovery and adventure as we explore the vibrant landscapes, rich history, and diverse cultures of South Asia together. Whether you are a seasoned traveler or embarking on your first adventure, let Air Travel be your guide to the extraordinary.</p>
        </div>
    </div>
    );
};
